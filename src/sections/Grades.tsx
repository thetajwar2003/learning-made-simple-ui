...
export default function Grades({ classCode }: CourseProps) {
  ...
  // Example usage:
  const gradeAPlus = convertGradeToNumber('A+'); // Returns 4.0
  const gradeCMinus = convertGradeToNumber('C-'); // Returns 1.7
  const gradeZ = convertGradeToNumber('Z'); // Returns 0.0 (default)
